...
?>
   ...
   <form action="" method="POST">
      ...
      <textarea name="comment_edit_box" required cols="30" rows="10" placeholder="Molimo unesite vas komentar"><?= $fetch_edit_comment['comment']; ?></textarea>
      <button type="submit" class="inline-btn" name="edit_comment">Izmenite komentar</button>
      <div class="inline-option-btn" onclick="window.location.href = 'user_comments.php';">Prekini</div>
   </form>
   </section>
<?php
   }
...
<section class="comments-container">
   ...
   <div class="user-comments-container">
      ...
      <div class="show-comments">
         ...
         ?>
         <div class="post-title"> Na : <span><?= $fetch_posts['title']; ?></span> <a href="view_post.php?post_id=<?= $fetch_posts['id']; ?>" >Pregledajte članak</a></div>
         <?php
            }
         ?>
