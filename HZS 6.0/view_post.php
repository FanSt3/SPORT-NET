...
<section class="comments-container">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment" maxlength="1000" class="comment-box" cols="30" rows="10" placeholder="Napišite vaš komentar" required></textarea>
      <input type="submit" value="Dodajte komentar" class="inline-btn" name="add_comment">
   </form>
   <?php
   }else{
   ?>
